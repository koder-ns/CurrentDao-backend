...
export declare class EnergyController {
    ...
    findOne(id: string): Promise<import("./entities/energy-trade.entity").EnergyTrade | null>;
    create(createEnergyTradeDto: CreateEnergyTradeDto): Promise<import("./entities/energy-trade.entity").EnergyTrade>;
    executeTrade(id: string): Promise<import("./entities/energy-trade.entity").EnergyTrade | null>;
