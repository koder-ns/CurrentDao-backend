...
export declare class EconomicIndicatorService {
    ...
    getGDPData(region: string | undefined, startDate: Date, endDate: Date): Promise<EconomicIndicator[]>;
    getInflationData(region: string | undefined, startDate: Date, endDate: Date): Promise<EconomicIndicator[]>;
    getUnemploymentData(region: string | undefined, startDate: Date, endDate: Date): Promise<EconomicIndicator[]>;
    getInterestRateData(region: string | undefined, startDate: Date, endDate: Date): Promise<EconomicIndicator[]>;
    getEnergyPrices(region: string | undefined, startDate: Date, endDate: Date): Promise<EconomicIndicator[]>;
