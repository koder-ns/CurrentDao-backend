...
export declare class CrossBorderController {
    ...
    getTransaction(transactionId: string): Promise<import("../entities/cross-border-transaction.entity").CrossBorderTransaction | null>;
    ...
    getSubmissionStatus(submissionId: string): Promise<import("../reporting/regulatory-report.service").ReportSubmission | null>;
